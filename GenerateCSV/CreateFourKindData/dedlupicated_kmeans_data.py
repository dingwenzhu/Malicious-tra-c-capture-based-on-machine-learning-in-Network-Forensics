#dedlupicated_kmeans_data.py
#Change Database of cluster and create clustered dedlupicated data
import os
import pandas as pd
...
data.to_csv('total_http_header_clustered.csv',index=False)
print(data)
...
df1.to_csv('total_http_header_train_unique_36_complete.csv',index=False)
df2=pd.DataFrame(test,columns=column)
df2.to_csv('total_http_header_test_unique_9_complete.csv',index=False)
traindata= pd.read_csv('total_http_header_train_unique_36_complete.csv',header=None)
testdata= pd.read_csv('total_http_header_test_unique_9_complete.csv',header=None)
#print(traindata)
#print(testdata)
#covert data to specific lable
textFile1=open('total_http_header_train_unique_36_complete.csv','rb')
data= pd.read_csv(textFile1)
textFile2=open('total_http_header_test_unique_9_complete.csv','rb')
...
df1.to_csv('total_http_header_train_unique_36_complete_convert.csv',index=False)
df2=pd.DataFrame(m2,columns=list1)
df2.to_csv('total_http_header_test_unique_9_complete_convert.csv',index=False)
#print("done")
